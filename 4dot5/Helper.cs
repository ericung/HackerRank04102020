...
namespace _4dot5
{
  ...
  public class Helper
  {
    ...
    // 4dot2
    public static Node CreateMinimalBSTRecursive(int[] array, int start, int end)
    {
      if (end < start)
      {
        return null;
      ...
      head.Left = CreateMinimalBSTRecursive(array, start, middle - 1);
      head.Right = CreateMinimalBSTRecursive(array, middle + 1, end);
      return head;
    }
